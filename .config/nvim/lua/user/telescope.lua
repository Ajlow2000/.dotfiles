...
vim.keymap.set("n", "<leader>cp", ":Telescope projects<cr>", { desc = "[Telescope] - Search Projects"})
...
vim.keymap.set("n", "<leader>d", ":Telescope diagnostics bufnr=0<cr>", { desc = "[Telescope/LSP] - View Document Diagnostics"})
vim.keymap.set("n", "<leader>wd", ":Telescope diagnostics<cr>", { desc = "[Telescope/LSP] - View Workspace Diagnostics"})
